...
namespace consoleProject
{
	static class Pendu
	{
			public static void penduGame()
			{
				...
				Utils.printCase1();
				Console.WriteLine("Le mot a trouver est : {0} ",new string (guessedWord).ToString());
				...
				while(round <= 8)
				{
					Console.WriteLine("Il vous reste {0}/8 tours !",round);
					...
					if(c == 'q') //si le joueur veut quitter
					{
						...
						if(Console.ReadKey().Equals('o') ) System.Environment.Exit(1) ;
					}
